...
//        imageView.setTranslationX(translationX);
    ...
    public void onClick(View v) {
        ...
        // values:表示从哪里旋转到哪里
//        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(v, "rotationY", 0.0f, 360.0f).setDuration(2000);
//        objectAnimator.start();

        // 第二个案例（监听动画执行过程）
        // 注：虽然我们输入的属性不存在，但是仍然会执行（指的是时间）
        // 非主流用法
//        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(v, "translationX", 0.0f, 500.0f);
...
//                Log.d("0-500", "animatedValue" + animatedValue);
//                // imageView.setAlpha(alpha);
//            }
//        });
...
//        ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(v, scaleXholder, scaleYholder);
//        objectAnimator.setDuration(2000);
//        objectAnimator.start();
//
//         // 第四个案例－－－－－－ValueAnimator－－－－－－－
...
//        });
        ...
        valueAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                PropertyValuesHolder scaleXholder = PropertyValuesHolder.ofFloat("scaleX", 0.0f, 1.0f);
                PropertyValuesHolder scaleYholder = PropertyValuesHolder.ofFloat("scaleY", 0.0f, 1.0f);
                ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(imageView, scaleXholder, 
                        scaleYholder);
                objectAnimator.setDuration(2000);
                objectAnimator.start();
            }
